...
def build_analysis(plain_text: str):
    ...
    def add_text(t: str):
        if t: segments.append({"type":"text","value":t})
    ...
    for label in LOADED_LABELS:
        ...
        if idx != -1:
            ...
            ev_counter += 1
            ev = {
                "id": ev_id, "text": span, "type": "malice",
                "alert": "NEUTRALITY ALERT", "category": "Loaded Labeling",
    ...
    rebuttal_ledger = [
        {"claim":"Article contains criminal allegations.","reality":"INTERNAL SCAN: No citations detected."}
    ]
    verdict = {
